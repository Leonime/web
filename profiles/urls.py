...
from profiles.views import UserProfileView, UserProfileDetailView, UserProfileReadOnlyView

app_name = 'profiles'
urlpatterns = [
    path('profiles/edit/', UserProfileView.as_view(), name='edit_profile'),
    path('profiles/view/', UserProfileReadOnlyView.as_view(), name='view_profile'),
