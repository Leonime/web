...
from frontend.views import ChirpDetail, ChirpList, ProfileDetail, ChirpFrontPageView, ChirpProfile
...
urlpatterns = [
    ...
    path('frontend/profile/', ChirpProfile.as_view(), name='chirp_profile'),
